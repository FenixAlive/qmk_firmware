...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GAME] = LAYOUT (
            ...
            KC_SFTENT     , TT(_THREE)  , GUI    , ALT_T(KC_TAB) , TT(_GTWO) , KC_SPC,
            KC_Y          , KC_U      , KC_I    , KC_O    , KC_P       , KC_BSPC,
            KC_H          , KC_J      , KC_K    , KC_L    , KC_SCLN    , KC_QUOT,
            KC_N          , KC_M      , KC_COMM , KC_DOT  , KC_SLSH    , KC_LALT
            ),
    [_GTWO] = LAYOUT (
            KC_MINS       , KC_DOT     , KC_7      , KC_8     , KC_9      , KC_ASTR,
            KC_GESC       , KC_0       , KC_4      , KC_5     , KC_6      , KC_PLUS,
            CTLBS         , KC_EQL     , KC_1      , KC_2     , KC_3      , KC_SLSH,
    ...
    [_THREE] = LAYOUT (
            _______      , KC_PGUP    , KC_HOME  , KC_UP    , KC_END      , KC_BRIU,
            TT(_NUMP)    , KC_LSFT    , KC_LEFT  , KC_DOWN  , KC_RGHT     , KC_BRID,
            _______      , KC_PGDN    , KC_ACL0  , KC_ACL1  , KC_ACL2     , KC_CALC,
    ...
    [_NUMP] = LAYOUT (
            _______      , KC_PAST    , KC_PMNS  , KC_PPLS  , _______     , _______,
            _______      , KC_PSLS    , KC_PDOT  , KC_PCMM  , _______     , _______,
            _______      , _______    , _______  , _______  , _______     , _______,
            _______      , _______    , _______  , _______  , _______     , _______,
            KC_PSLS      , KC_KP_7    , KC_KP_8  , KC_KP_9  , KC_PAST     , KC_NLCK,
            KC_KP_0      , KC_KP_4    , KC_KP_5  , KC_KP_6  , KC_PMNS     , KC_PENT,
            KC_PEQL      , KC_KP_1    , KC_KP_2  , KC_KP_3  , KC_PPLS     , KC_PDOT
            ),
    [_ADJUST] = LAYOUT (
