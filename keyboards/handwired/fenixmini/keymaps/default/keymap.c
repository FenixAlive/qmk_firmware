...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_TWO] = LAYOUT (
            ...
            CTL_T(KC_BSLS), S(KC_BSLS)   , KC_TILD   , KC_LBRC         , KC_RBRC  , KC_UNDS,
            _______       , _______      , _______   , _______         , _______  , _______,
            KC_SLSH       , KC_7         , KC_8      , KC_9            , KC_ASTR  , KC_DEL,
            KC_0          , KC_4         , KC_5      , KC_6            , KC_MINS  , KC_INS,
            KC_DOT        , KC_1         , KC_2      , KC_3            , KC_PLUS  , ALT_T(KC_EQL)
            ),
    [_THREE] = LAYOUT (
