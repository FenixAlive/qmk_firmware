...
#define DEL   MT(LCA(KC_DEL), KC_DEL)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_TWO] = LAYOUT (
            ...
            S(KC_BSLS)    , KC_UNDS      , KC_TILD  , KC_LBRC    , KC_RBRC      , KC_BSLS,
            _______       , _______   , _______  , LGUI_T(ALGR(KC_1))  , _______  , _______,
            KC_SLSH       , KC_7      , KC_8    , KC_9    , KC_ASTR    , DEL,
    ...
    [_ADJUST] = LAYOUT (
            ...
            _______      , QWERTY     , GAME       , CHITA    , RESET     , _______,
